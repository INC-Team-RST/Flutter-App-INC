...
class GetSharedAdmin extends StatefulWidget {
  const GetSharedAdmin({Key? key, required this.userId}) : super(key: key);

  final int userId;

  @override
  State<GetSharedAdmin> createState() => _GetSharedAdminState();
}

class _GetSharedAdminState extends State<GetSharedAdmin> {
